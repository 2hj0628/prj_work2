...
[ 프로젝트 파일 구조 ]
Project_code > 
	main_full.py	- 네이버 영화 리뷰 수집데이터 전처리 및 감성분석, 영화관 입장권 데이터 전처리	** 실행파일
...
//가상환경 구동 중 권한 오류 발생시 - case1
Set-ExecutionPolicy -ExecutionPolicy Unrestricted -Scope CurrentUser
(또는 Set-ExecutionPolicy Unrestricted)

//가상환경 구동 중 권한 오류 발생시 - case2
case1 로 설정해도, 스크립트 실행 여부를 확인할 때
...
################ Visual Studio Code 패키지 설치
터미널 창에서 pip install -r requirements.txt 입력
